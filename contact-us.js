...
function validateform() {
    if (!validateName() || !validatePhone() || !validateEmail() || !validateMessage()) {
        ...
        submitError.innerHTML = 'Please fill all the Input field correctly';
...
function register() {
    ...
    let emails = document.querySelector("#contact-email").value;


    localStorage.setItem("Username", name);
    localStorage.setItem("Phone", phone);
    localStorage.setItem("Useremail", emails);
}
